...
#
#     # Back propagate to update weights and bias. (역전파)
#     weights_0_1, bias_0_1, weights_1_2, bias_1_2 = backPropogate(weights_0_1, bias_0_1, weights_1_2, bias_1_2)
#
#
# # printing output
# print('Actual data:')
