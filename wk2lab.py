...
# from sklearn.ensemble import RandomForestRegressor   #ols 대신 ㅋㅋ
...
#         dfImportance = dfImportance._append({"importance":importances[i],
...
#
# # dataframe.. not npArray.. use iloc for this exercise
# # Extract the two most important features
# important_indices = [feature_list.index('petal length'), feature_list.index('petal width'), feature_list.index('sepal length'), feature_list.index('sepal width') ]
...
# features = pd.read_csv('data/temperatures.csv')
#
# # Show all columns.
...
# rf = RandomForestRegressor(n_estimators = 1000, max_features= 6, max_depth= 5, bootstrap = True)   #fit 1000 trees.. slower than OLS
#
